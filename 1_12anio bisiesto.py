...
x, y = calendar.monthrange(anio1, 2)
# en realidad devuelve cuantos dias de fines de semana hay en el mes, y cuantos dias tiene ese mes
# por lo que solo utilizo cuantos dias tendra febrero ese año para saber si es
# bisiestro o no.
